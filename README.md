...
Both together :
    sudo docker-compose -p ckan-docker-template -f docker-compose.dev.yml up -d --build
...
docker-compose -p ckan-docker-template -f docker-compose.dev.yml exec ckan-dev /bin/bash -c "ckan generate extension --output-dir /srv/app/src_extensions"
